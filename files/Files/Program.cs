...
namespace Files
{
    internal class Program
    {
        ...
        class Person
        {
            ...
            {
                string fileName = "U:\\PRG\\" + Name + ".txt";
            ...
            public static Person LoadFromTxt()
            {
                    ...
                    if (File.Exists(fileName))
                    {
                        using (StreamReader reader = new StreamReader(fileName))
                        {
                            ...
                            float height;
                            float weight;
                            float.TryParse(reader.ReadLine(), out height);
                            float.TryParse(reader.ReadLine(), out weight);
                            return new Person(name, height, weight);
                        }
                    }
                    else
                    {
                        Console.WriteLine("Nic to nenaslo, gg: " + fileName);
                        return null;
                    }
                }
